 ...
 * 
 * @export
 * @interface TimeEntriesUpdateEntryResponseDataTimeEntryOut
 */
export interface TimeEntriesUpdateEntryResponseDataTimeEntryOut {
    /**
     * 
     * @type {string}
     * @memberof TimeEntriesUpdateEntryResponseDataTimeEntryOut
     */
    'date'?: string;
    /**
     * 
