 ...
 * 
 * @export
 * @interface TimeEntriesCreateNewEntryResponseDataTimeEntryIn
 */
export interface TimeEntriesCreateNewEntryResponseDataTimeEntryIn {
    /**
     * 
     * @type {string}
     * @memberof TimeEntriesCreateNewEntryResponseDataTimeEntryIn
     */
    'date'?: string;
    /**
     * 
