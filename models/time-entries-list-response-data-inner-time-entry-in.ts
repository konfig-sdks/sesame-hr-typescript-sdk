 ...
 * 
 * @export
 * @interface TimeEntriesListResponseDataInnerTimeEntryIn
 */
export interface TimeEntriesListResponseDataInnerTimeEntryIn {
    /**
     * 
     * @type {string}
     * @memberof TimeEntriesListResponseDataInnerTimeEntryIn
     */
    'date'?: string;
    /**
     * 
