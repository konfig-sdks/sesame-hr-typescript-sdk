...
/**
 * This class provides a wrapper for network errors when making requests to Sesame Public API
 */
export class SesameHrError extends Error {
  /**
   * The response body
   */
